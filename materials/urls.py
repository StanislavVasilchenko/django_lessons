...
from materials.views import MaterialCreateView, MaterialListView, MateriaDetailView, MaterialUpdateView, MateriaDelete
...
urlpatterns = [
    ...
    path("delete/<int:pk>", MateriaDelete.as_view(), name="delete"),
]
