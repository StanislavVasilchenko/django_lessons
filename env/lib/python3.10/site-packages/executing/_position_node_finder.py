...
class PositionNodeFinder(object):
    ...
    def verify(self, node: EnhancedAST, instruction: dis.Instruction) -> None:
        ...
        if op_name.startswith(("BINARY_SUBSCR", "SLICE+")):
            ...
            def extra_filter(e): return isinstance(
                cast(ast.BinOp, e).op, op_type)
            ...
            typ = ast.Attribute
            ctx = ast.Load
            def extra_filter(e): return mangled_name(e) == instruction.argval
        elif op_name in (
            "LOAD_NAME",
            "LOAD_GLOBAL",
            "LOAD_FAST",
            ...
            typ = ast.Name
            ctx = ast.Load
            def extra_filter(e): return cast(
                ast.Name, e).id == instruction.argval
        elif op_name in ("COMPARE_OP", "IS_OP", "CONTAINS_OP"):
            typ = ast.Compare
            def extra_filter(e): return len(cast(ast.Compare, e).ops) == 1
