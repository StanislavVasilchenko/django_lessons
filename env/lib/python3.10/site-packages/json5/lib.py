...
def loads(s, encoding=None, cls=None, object_hook=None, parse_float=None,
    ...
    if object_pairs_hook:
        ...
        def dictify(pairs): return object_hook(dict(pairs))
    else:
        def dictify(pairs): return dict(
            pairs)  # pylint: disable=unnecessary-lambda

    if not allow_duplicate_keys:
        _orig_dictify = dictify
        def dictify(pairs): return _reject_duplicate_keys(pairs, _orig_dictify)
