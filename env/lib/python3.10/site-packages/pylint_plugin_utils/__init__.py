...
def augment_visit(linter: PyLinter, checker_method, augmentation):
    ...
    try:
        ...
        checker = get_checker(linter, get_class(
    ...
    setattr(checker, checker_method.__name__,
            AugmentFunc(old_method, augmentation))
...
def suppress_message(linter: PyLinter, checker_method, message_id_or_symbol, test_func):
    ...
    """
    augment_visit(linter, checker_method, DoSuppress(
        linter, message_id_or_symbol, test_func))
