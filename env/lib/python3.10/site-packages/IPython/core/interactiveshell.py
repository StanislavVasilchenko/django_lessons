...
class InteractiveShell(SingletonConfigurable):
    ...
    builtin_trap = Instance(
        "IPython.core.builtin_trap.BuiltinTrap", allow_none=True
    )
    display_trap = Instance(
        "IPython.core.display_trap.DisplayTrap", allow_none=True
    )
    ...
    magics_manager = Instance(
        "IPython.core.magic.MagicsManager", allow_none=True
    )
    ...
    def enable_matplotlib(self, gui=None):
        ...
        self.enable_gui(gui)
        self.magics_manager.registry[
            "ExecutionMagics"
        ].default_runner = pt.mpl_runner(self.safe_execfile)
