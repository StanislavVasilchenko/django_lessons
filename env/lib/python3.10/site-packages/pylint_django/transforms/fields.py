    ...
    if cls.name in _STR_FIELDS:
        ...
        try:
            base_nodes = MANAGER.ast_from_module_name(
                "_decimal").lookup("Decimal")
        except AstroidImportError:
            base_nodes = MANAGER.ast_from_module_name(
                "_pydecimal").lookup("Decimal")
...
def add_transforms(manager):
    manager.register_transform(nodes.ClassDef, inference_tip(
        apply_type_shim), is_model_or_form_field)
