...
class BaseFileLock(ABC, contextlib.ContextDecorator):
    ...
    _instances: ClassVar[WeakValueDictionary[str,
                                             BaseFileLock]] = WeakValueDictionary()
    ...
    def __new__(  # noqa: PLR0913
        ...
        **kwargs: dict[str, Any],  # capture remaining kwargs for subclasses  # noqa: ARG003
        ...
        # type: ignore[return-value] # https://github.com/python/mypy/issues/15322
        return instance
    ...
    def __init__(  # noqa: PLR0913
        ...
        *,
        ...
        self._context: FileLockContext = (
            ThreadLocalFileContext if thread_local else FileLockContext)(**kwargs)
        ...
        try:
            while True:
                if not self.is_locked:
                    ...
                    self._acquire()
                if self.is_locked:
                    _LOGGER.debug("Lock %s acquired on %s",
